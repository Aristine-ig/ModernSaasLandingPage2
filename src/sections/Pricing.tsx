  ...
  return (
    <section className="py-24">
      <div className="container">
        <h2 className="section-title py-2">Pricing</h2>
        <p className="section-description mt-2">
          Free For Limited period. Upgrade for unlimited tasks, better security,
        ...
        <div>
          {pricingTiers.map(
            ({
              ...
              <div key={index} className='p-10 border border-[#f1f1f1] rounded-3xl shadow-[0_7px_14px_#eaeaea]'>
